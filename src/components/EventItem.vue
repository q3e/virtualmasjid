  ...
  <template v-if="event">
    <div class="event-intro">
      ...
      <div class="event-info">
        ...
        <div class="event-style srm" v-if="event.is_live == true" v-bind:style="{backgroundColor:'#FF0000'}">Live</div>
        <div class="event-style srm" v-else v-bind:style="{backgroundColor:'#FFFF00'}">Recorded</div>
      ...
      <div class="event-details">
        <div class="find-it">
          ...
          <ul class="find-it-list">
            <li><a target="_blank" :href="event.stream_link">{{ event.stream_medium }}</a></li>
          </ul>
        </div>
      </div>
    </b-collapse>
